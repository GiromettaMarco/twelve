...
export type CalendarWideProps = DayPickerProps & {
  /**
...
function CalendarWide({
  ...
  const _monthGridClassName = cn('mx-auto mt-4 w-full', props.monthGridClassName)
  const _weekClassName = cn('max-width mt-2 grid grid-cols-7 items-start gap-1', props.weekClassName)
  const _dayClassName = cn('flex w-full items-center justify-center p-0 text-sm', props.dayClassName)
  const _dayButtonClassName = cn(
    buttonVariants({ variant: 'ghost' }),
    'h-8 w-5/6 rounded-md p-0 font-normal transition-none aria-selected:opacity-100',
...
CalendarWide.displayName = 'Calendar'
...
function Nav({
  ...
  }, [displayYears.from, displayYears.to, navView, previousMonth, goToMonth, onPrevClick, setDisplayYears])
  ...
  }, [displayYears.from, displayYears.to, navView, nextMonth, goToMonth, onNextClick, setDisplayYears])
  return (
